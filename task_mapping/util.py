...
def get_args():
    ...
    parser.add_argument('--train_data', type=str,
                        default='/home/nurullah/Desktop/data_valid_gayo_squential_split/9/train',
                        help='location of the data corpus')
    parser.add_argument('--valid_data', type=str,
                        default='/home/nurullah/Desktop/data_valid_gayo_squential_split/9/valid',
                        help='location of the data corpus')

    parser.add_argument('--test_data', type=str,
                        default='/home/nurullah/Desktop/data_valid_gayo_squential_split/9/test.csv',
                        help='location of the data corpus')
