...
class LinearLayer(nn.Module):
    ...
    def __init__(self):
        ...
        self.concatf = nn.Linear(900,300)
        self.concat2 = nn.Linear(300,100)
        self.classifier = nn.Linear(100,1)
        self.sigmoid = nn.Sigmoid()
        self.dropout = nn.Dropout(0.5)


    def forward(self, pairwisef, cosf, euclidf):
        ...
        concatf = torch.cat([pairwisef, cosf, euclidf],dim=1)
        concatf = self.dropout(self.relu(self.concatf(concatf)))

        x = torch.cat([concatf], dim=1)
...
class Siamese(nn.Module):
    ...
    def forward(self, q1_fast,q1_len, q2_fast, q2_len):
        #
        ...
        q1_fast = self.LSTM2(q1_fast, q1_len)
        ...
        #
        # x = self.LinearLayer( pairwise_f, cos_f, euclid_f)
        #
        # cos = (cos_f + cos_f) / 2
        return 0, q1_fast
